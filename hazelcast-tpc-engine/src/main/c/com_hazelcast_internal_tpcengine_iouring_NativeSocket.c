...
#include "include/com_hazelcast_internal_tpcengine_iouring_NativeSocket.h"
...
Java_com_hazelcast_internal_tpcengine_iouring_NativeSocket_toInetSocketAddress(JNIEnv* env, jclass this_class,
                                                                   jlong addr, jlong l){
...
Java_com_hazelcast_internal_tpcengine_iouring_NativeSocket_initNative(JNIEnv* env, jclass this_class){
...
Java_com_hazelcast_internal_tpcengine_iouring_NativeSocket_socket(JNIEnv* env, jclass this_class, jint type,
                                                      jint domain, jint protocol){
    return socket(type, domain, protocol);
}

JNIEXPORT void JNICALL
Java_com_hazelcast_internal_tpcengine_iouring_NativeSocket_listen(JNIEnv* env, jclass this_class, jint sock_fd,
                                                      jint backlog){
...
JNIEXPORT jint JNICALL
Java_com_hazelcast_internal_tpcengine_iouring_NativeSocket_bind(JNIEnv* env, jclass this_class, jint sock_fd,
...
JNIEXPORT void JNICALL
Java_com_hazelcast_internal_tpcengine_iouring_NativeSocket_connect(JNIEnv *env, jclass this_class, jint sock_fd,
...
JNIEXPORT void JNICALL
Java_com_hazelcast_internal_tpcengine_iouring_NativeSocket_setTcpNoDelay(JNIEnv *env, jclass this_class, jint sock_fd,
                                                             jboolean tcpNoDelay){
...
Java_com_hazelcast_internal_tpcengine_iouring_NativeSocket_isTcpNoDelay(JNIEnv* env, jclass this_class, jint sock_fd){
    int option_value;
...
JNIEXPORT void JNICALL
Java_com_hazelcast_internal_tpcengine_iouring_NativeSocket_setSendBufferSize(JNIEnv* env, jclass this_class, jint sock_fd,
                                                                 jint sendBufferSize){
...
JNIEXPORT jint JNICALL
Java_com_hazelcast_internal_tpcengine_iouring_NativeSocket_getSendBufferSize(JNIEnv* env, jclass this_class, jint sock_fd){
    int option_value;
    int option_len = sizeof(option_value);
...
JNIEXPORT void JNICALL
Java_com_hazelcast_internal_tpcengine_iouring_NativeSocket_setReceiveBufferSize(JNIEnv* env, jclass this_class, jint sock_fd,
...
JNIEXPORT jint JNICALL
Java_com_hazelcast_internal_tpcengine_iouring_NativeSocket_getReceiveBufferSize(JNIEnv* env, jclass this_class, jint sock_fd){
    int option_value;
    int option_len = sizeof(option_value);
...
JNIEXPORT jboolean JNICALL
Java_com_hazelcast_internal_tpcengine_iouring_NativeSocket_isReuseAddress(JNIEnv* env, jclass this_class, jint sock_fd){
    int option_value;
    int option_len = sizeof(option_value);
...
JNIEXPORT void JNICALL
Java_com_hazelcast_internal_tpcengine_iouring_NativeSocket_setReuseAddress(JNIEnv* env, jclass this_class, jint sock_fd,
...
JNIEXPORT jboolean JNICALL
Java_com_hazelcast_internal_tpcengine_iouring_NativeSocket_isReusePort(JNIEnv* env, jclass this_class, jint sock_fd){
    int option_value;
    int option_len = sizeof(option_value);
...
JNIEXPORT void JNICALL
Java_com_hazelcast_internal_tpcengine_iouring_NativeSocket_setReusePort(JNIEnv* env, jclass this_class, jint sock_fd,
                                                            jboolean reusePort){
...
JNIEXPORT jboolean JNICALL
Java_com_hazelcast_internal_tpcengine_iouring_NativeSocket_isKeepAlive(JNIEnv* env, jclass this_class, jint sock_fd){
    int option_value;
    int option_len = sizeof(option_value);
...
JNIEXPORT void JNICALL
Java_com_hazelcast_internal_tpcengine_iouring_NativeSocket_setKeepAlive(JNIEnv* env, jclass this_class, jint sock_fd,
                                                            jboolean keepAlive){
...
JNIEXPORT jint JNICALL
Java_com_hazelcast_internal_tpcengine_iouring_NativeSocket_getTcpKeepAliveTime(JNIEnv* env, jclass this_class, jint sock_fd){
    int option_value;
    int option_len = sizeof(option_value);
...
JNIEXPORT void JNICALL
Java_com_hazelcast_internal_tpcengine_iouring_NativeSocket_setTcpKeepAliveTime(JNIEnv* env, jclass this_class, jint sock_fd,
...
JNIEXPORT jint JNICALL
Java_com_hazelcast_internal_tpcengine_iouring_NativeSocket_getTcpKeepaliveIntvl(JNIEnv* env, jclass this_class, jint sock_fd){
    int option_value;
    int option_len = sizeof(option_value);
...
JNIEXPORT void JNICALL
Java_com_hazelcast_internal_tpcengine_iouring_NativeSocket_setTcpKeepaliveIntvl(JNIEnv* env, jclass this_class, jint sock_fd,
...
JNIEXPORT jint JNICALL
Java_com_hazelcast_internal_tpcengine_iouring_NativeSocket_getTcpKeepaliveProbes(JNIEnv* env, jclass this_class, jint sock_fd){
    int option_value;
    int option_len = sizeof(option_value);
...
JNIEXPORT void JNICALL
Java_com_hazelcast_internal_tpcengine_iouring_NativeSocket_setTcpKeepAliveProbes(JNIEnv* env, jclass this_class, jint sock_fd,
...
JNIEXPORT void JNICALL
Java_com_hazelcast_internal_tpcengine_iouring_NativeSocket_setSoLinger(JNIEnv* env, jclass this_class, jint sock_fd,
                                                           jint soLinger){
...
JNIEXPORT jint JNICALL
Java_com_hazelcast_internal_tpcengine_iouring_NativeSocket_getSoLinger(JNIEnv* env, jclass this_class, jint sock_fd){
    struct linger option_value;
    int option_len = sizeof(option_value);
...
JNIEXPORT jobject JNICALL
Java_com_hazelcast_internal_tpcengine_iouring_NativeSocket_getLocalAddress(JNIEnv* env, jclass this_class, jint sock_fd){
...
JNIEXPORT jobject JNICALL
Java_com_hazelcast_internal_tpcengine_iouring_NativeSocket_getRemoteAddress(JNIEnv* env, jclass this_class, jint sock_fd){
    struct sockaddr_storage addr;
    socklen_t addr_len = sizeof(addr);
...
JNIEXPORT void JNICALL
Java_com_hazelcast_internal_tpcengine_iouring_NativeSocket_setBlocking(JNIEnv* env, jclass this_class,
