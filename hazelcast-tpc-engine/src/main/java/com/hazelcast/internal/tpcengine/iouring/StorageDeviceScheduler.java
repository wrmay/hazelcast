...
import com.hazelcast.internal.tpcengine.StorageDevice;
...
public class StorageDeviceScheduler {
    ...
    public StorageDeviceScheduler(StorageDevice dev,
        ...
        this.pending = new CircularQueue<>(dev.getMaxPending());
        this.opAllocator = new SlabAllocator<>(dev.getMaxPending(), Op::new);
    ...
    public Promise<Integer> schedule(IOUringAsyncFile file,
        ...
        if (concurrent < maxConcurrent) {
            ...
            promise.completeWithIOException("Overload", null);
        }
    ...
    private class Op implements IOCompletionHandler {
        ...
        public void handle(int res, int flags, long userdata) {
            concurrent--;
            if (res < 0) {
                String message = file.path() + " res=" + -res + " " + Linux.strerror(-res) + " " + this;
