 ...
 */
public class MemberTpcRuntime implements TpcRuntime {
    ...
    public MemberTpcRuntime(Node node) {
        this.node = node;
        this.logger = node.getLogger(MemberTpcRuntime.class);
        ...
        this.poolRemoteResponses = parseBoolean(getProperty("hazelcast.alto.pool-remote-responses", "true"));
    ...
    public int getPartitionCount() {
        return node.nodeEngine.getPartitionService().getPartitionCount();
    }
