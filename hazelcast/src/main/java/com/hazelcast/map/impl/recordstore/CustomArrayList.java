        ...
        implements List<E>, RandomAccess, Cloneable, java.io.Serializable
{
    ...
    private void grow(int minCapacity) {
        System.out.println("Growing, capacity: " + elementData.length + ", size: " + size +
    ...
    private class Itr implements Iterator<E> {
        ...
        public void forEachRemaining(Consumer<? super E> consumer) {
            ...
            final Object[] elementData = CustomArrayList.this.elementData;
            if (i >= elementData.length) {
                throw new ConcurrentModificationException();
            }
    ...
    static final class ArrayListSpliterator<E> implements Spliterator<E> {
        ...
        ArrayListSpliterator(CustomArrayList<E> list, int origin, int fence,
        ...
        public void forEachRemaining(Consumer<? super E> action) {
            ...
            CustomArrayList<E> lst; Object[] a;
            if (action == null)
                throw new NullPointerException();
