...
public class PublisherService implements PartitionAwareOperation, ManagedService, RemoteService {

    public static final String SERVICE_NAME = "hz:impl:publisherService";
    private final NodeEngineImpl nodeEngine;

    public PublisherService(NodeEngineImpl nodeEngine) {
    ...
    public DistributedObject createDistributedObject(String objectName, UUID source, boolean local) {
        return new PublisherProxy(nodeEngine, this, objectName);
    }
